		...
		{			
			...
			if(!empty($_FILES['photo']['name'])) // ici on execute le code uniquement s'il y a upload donc si on fait une modification ça ne marche pas.
			{
				//--DEBUT UPLOAD FICHIER-----------------------------------------------------------------
					...
					$photo_bdd = RACINE_SITE . $nom_photo;
					//echo $photo_bdd;
			...
			('$_POST[id_produit]' , '$titre' , '$nom_photo' , '$_POST[prix]' , '$_POST[categorie]' , '$_POST[stock]' , '$_POST[ref]' , '$_POST[fidelite]' , '".$descriptif."' ,  '$_POST[diametre]' , '$matiere' , '$_POST[hauteur]' , '$_POST[poids]' , '$_POST[contenance]' , '$caracteristique5' , '$caracteristique6' , '$caracteristique7' , '$caracteristique8' , '$caracteristique9' , '$caracteristique10' , '$caracteristique11' , '$caracteristique12' , '$complement' , '1')");
		}
	}
...
//**********************************************************************************************************	
	...
	include("../inc/barre_navigation_inc.php");	
...
<!-- **************************************************************************************** -->	
				...
				<div id="colonne-unique" class="colonne2"> <!-- début colonne 2-->	
					...
					<?php 
						if(isset($_GET['page'])){
						$i = 1;
						echo "<p><a href='?action=affichage&page=".$i."#pagination'><< - </a>";
						for ($i = 1; $i <= $nb_pages; $i++) { echo "<a href='?action=affichage&page=".$i."#pagination'>".$i."</a> - "; }
						echo "<a href='?action=affichage&page=".$nb_pages."#pagination'>>></a></p>";
						};
					?>
					</div>					
<?php
...
//**********************************************************************************************************		
	...
	if(isset($_GET['action']) && $_GET['action']== "affichage")
	{
		...
		$resultat = execute_requete("SELECT *
			...
			GROUP BY  p.id_produit ".$col." ".$tri." LIMIT ".$limite.",".$nb_produit_page.""); // EXECUTION DE LA REQUETE DE SELECTION
		//debug($resultat);
?>					
					...
					<div id="tableau">
						...
						<th scope="col" class="petit"><div class="filtre"><a href="#"><img src="<?php echo RACINE_SITE ?>image/fleche-haute.gif"/></a><a href="#"><img src="<?php echo RACINE_SITE ?>image/fleche-bas.gif"/></a></div></th>
						<th scope="col" class="petit"><div class="filtre"><a href="#"><img src="<?php echo RACINE_SITE ?>image/fleche-haute.gif"/></a><a href="#"><img src="<?php echo RACINE_SITE ?>image/fleche-bas.gif"/></a></div></th>
						<th scope="col" class="tailleth"><div class="filtre"><a href="#"><img src="<?php echo RACINE_SITE ?>image/fleche-haute.gif"/></a><a href="#"><img src="<?php echo RACINE_SITE ?>image/fleche-bas.gif"/></a></div></th>
						<th scope="col" class="tailleth"><div class="filtre"><a href="#"><img src="<?php echo RACINE_SITE ?>image/fleche-haute.gif"/></a><a href="#"><img src="<?php echo RACINE_SITE ?>image/fleche-bas.gif"/></a></div></th>
						<th scope="col" class="petit"><div class="filtre"><a href="#"><img src="<?php echo RACINE_SITE ?>image/fleche-haute.gif"/></a><a href="#"><img src="<?php echo RACINE_SITE ?>image/fleche-bas.gif"/></a></div></th>
						<th scope="col" class="petit"><div class="filtre"><a href="#"><img src="<?php echo RACINE_SITE ?>image/fleche-haute.gif"/></a><a href="#"><img src="<?php echo RACINE_SITE ?>image/fleche-bas.gif"/></a></div></th>
						<th scope="col"></th>
...
<?php											
		while($ligne = $resultat->fetch_assoc())
			{			
							$note = execute_requete("SELECT AVG(note) AS moyenne
							FROM produit p, avis a
							WHERE p.id_produit = ".$ligne['id_produit']."
							AND a.id_produit= ".$ligne['id_produit']."
							GROUP BY a.id_avis");
							
							$moyenne_note = $note->fetch_assoc();
							$MOYENNE = $moyenne_note['moyenne'];
?>						
						<tr>
			...
			?>
						...
						<div class="fiche-produit-action admin_fiche_produit_action ">
							...
							<input type="text" id="id_produit" name="id_produit" readonly value="<?php if(isset($_POST['id_produit'])) {echo $_POST['id_produit'];}?>" style="width : 40px" /> <br />													
								...
								<div class="fiche-produit-prix-stock admin_prix_stock">
									...
									<p class="vert">Catégorie du produit :</p> 
									 <select class="categorie_produit" name="categorie">
									  <option value="E-cigarettes" <?php if(isset($_POST['categorie'])&& $_POST['categorie']=="E-cigarettes") echo "selected";
																	 elseif (!isset($_POST['categorie'])) echo "selected";?> >E-cigarettes</option> 
									  <option value="E-liquides" <?php if(isset($_POST['categorie'])&& $_POST['categorie']=="E-liquides") echo "selected";
																	 elseif (!isset($_POST['categorie'])) echo "selected";?> >E-liquides</option>
									  <option value="Accessoires" <?php if(isset($_POST['categorie'])&& $_POST['categorie']=="Accessoires") echo "selected";
																	 elseif (!isset($_POST['categorie'])) echo "selected";?> >Accessoires</option>
									</select><br/>
								...
								<div class="fiche-produit-point-fidelite admin_point_fidelite">
									<p class="point_fidelite_phrase">Cet achat pourra rapporter :</p>
									<p class="point_fidelite"><input type="text" name="fidelite" id="points" value="<?php if(isset($_POST['fidelite'])) {echo $_POST['fidelite'];}?>"/> POINTS <br />de fidélité</p>
									<p class="point_fidelite_phrase">avec la carte de fidélité Quai des vaps</p>
