...
<!-- **************************************************************************************** -->	
				...
				<div class="colonne2"> <!-- début colonne 2-->	
					...
					<a href="<?php echo RACINE_SITE ?>boutique.php?cat=<?php echo $_GET['cat'] ?>&tri=fidelite&ordre=asc">Fidélité croissante &#124;</a>
					<a href="<?php echo RACINE_SITE ?>boutique.php?cat=<?php echo $_GET['cat'] ?>&tri=fidelite&ordre=desc">Fidélité décroissante</a> 
					</p>
					</div>
