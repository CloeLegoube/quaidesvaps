...
<!-- **************************************************************************************** -->	
					...
					<div id="header_droite"><!-- début header_droite -->
						...
						<nav id="main-menu"><!-- début menu -->
									...
									<a href="<?php echo RACINE_SITE ?>magasin.php">Votre Magasin</a>						
									<a href="<?php echo RACINE_SITE ?>blog.php">Le Blog</a>						
						</nav><!-- fin menu -->
						
						
						<!-- Slogan -->
						<h1 id="slogan">Boutique de Cigarettes Electronique située à Courbevoie à deux pas de la gare de Bécon-Les-Bruyères</h1>
