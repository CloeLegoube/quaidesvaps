...
function creation_du_panier()
{
	if(!isset($_SESSION['panier']))
	{
		...
		$_SESSION['panier']['fidelite'] = array();
...
function ajout_produit_au_panier($titre, $id_produit, $photo, $descriptif, $quantite, $fidelite, $categorie, $prix, $prix_promo, $id_promo, $code_promo, $reduction)
{
    ...
    $_SESSION['panier']['fidelite'][] = $fidelite ;
...
function retirer_produit_du_panier ($position)
{
    ...
    array_splice($_SESSION['panier']['fidelite'], $position, 1);
...
//**********************************************************************************************************	
 ...
 echo dateConvertFrEn("2010-06-01","/");
 // AFFICHERA : 01/06/2010
 ...
 echo dateConvertFrEn("01-06-2010");
 // AFFICHERA : 2010-06-01
 */
