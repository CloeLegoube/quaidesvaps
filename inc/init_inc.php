<?php
	...
	define("RACINE_SITE", "http://www.cloelegoube.com/ifocop/"); // On écrit le chemin de notre site. Si on le change de place, on aura simplement à changer cette constante.
	//echo RACINE_SITE;
