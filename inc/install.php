<?php
	...
	define("RACINE_SITE", "http://e2r7p21.42.fr:8080/Rush00/"); // On écrit le chemin de notre site. Si on le change de place, on aura simplement à changer cette constante.
	//echo RACINE_SITE;
