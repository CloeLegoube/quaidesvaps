<?php
	...
	define("RACINE_SITE", "https://github.com/CloeLegoube/quaidesvaps.git"); // On écrit le chemin de notre site. Si on le change de place, on aura simplement à changer cette constante.
	//echo RACINE_SITE;
