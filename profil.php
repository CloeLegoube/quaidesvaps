...
?>								
					<!--
					<table id="tableau_admin" class="tableau_panier" summary="Gestion administrateur">
					<caption>COMMANDE N° 1482</caption>
					<thead>
					<tr>					
					<th scope="col">Produit</th>
					<th scope="col">Photo</th>
					...
					<td colspan="2">TVA 20% : 21€</td>
					<td colspan="2">84€ HT</td>
					</tr>
					
					<tr>
					<th scope="row" colspan="2">MONTANT TOTAL</th>
					<td colspan="2">3 produits pour cette commande</td>
					<td colspan="2"><strong>105€ TTC</strong></td>
					</tr>
					</tfoot>
					
					<tbody>
					<tr>
						<td>Ego premium bleu</td>						
						<td><img src="<?php echo RACINE_SITE ?>image/ego_premium_bleu_boutique.jpg"  width="100" height="70" alt="ego premium bleu"/></td>						
						<td ><div>Le Kit e-smart Kanger est destiné aux petis et moyens vapoteurs
							E-cigarette raffinée, très simple à utiliser et entretenir 
							Kit décliné en noir, blanc et rouge</div></td>
						<td>35,00€</td>	
						<td >1</td>						
						<td>35,00€</td>						
